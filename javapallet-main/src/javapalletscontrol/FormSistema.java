...
public class FormSistema extends javax.swing.JFrame {
    ...
    void mostraPilha(Stack<Produto> minhaPilha, JTextArea meuList){
        meuList.setText("");
        for(Produto p:minhaPilha)
            meuList.append(p + "\n");
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        Produto p; //ponteiro capaz de receber um produto que ja existe
        while(!minhaPilha.isEmpty()){
            p = minhaPilha.peek(); //pega o topo
